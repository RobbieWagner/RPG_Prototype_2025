...
public partial class @GameControls: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        // BLOCK_BREAK
        m_BLOCK_BREAK = asset.FindActionMap("BLOCK_BREAK", throwIfNotFound: true);
        m_BLOCK_BREAK_Select = m_BLOCK_BREAK.FindAction("Select", throwIfNotFound: true);
        m_BLOCK_BREAK_Cancel = m_BLOCK_BREAK.FindAction("Cancel", throwIfNotFound: true);
        m_BLOCK_BREAK_Navigate = m_BLOCK_BREAK.FindAction("Navigate", throwIfNotFound: true);
        m_BLOCK_BREAK_CombatDetails = m_BLOCK_BREAK.FindAction("CombatDetails", throwIfNotFound: true);
        m_BLOCK_BREAK_RightClick = m_BLOCK_BREAK.FindAction("RightClick", throwIfNotFound: true);
        // DIALOGUE
    ...
    ~@GameControls()
    {
        ...
        UnityEngine.Debug.Assert(!m_BLOCK_BREAK.enabled, "This will cause a leak and performance issues, GameControls.BLOCK_BREAK.Disable() has not been called.");
        ...
        UnityEngine.Debug.Assert(!m_FISHING.enabled, "This will cause a leak and performance issues, GameControls.FISHING.Disable() has not been called.");
    }
    ...
    public struct EXPLORATIONActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "EXPLORATION/MouseLook".
        /// </summary>
        public InputAction @MouseLook => m_Wrapper.m_EXPLORATION_MouseLook;
        /// <summary>
        /// Provides access to the underlying input action "EXPLORATION/ControllerLook".
        /// </summary>
        public InputAction @ControllerLook => m_Wrapper.m_EXPLORATION_ControllerLook;
        /// <summary>
        /// Provides access to the underlying input action "EXPLORATION/ExplorationMenu".
        /// </summary>
        public InputAction @ExplorationMenu => m_Wrapper.m_EXPLORATION_ExplorationMenu;
        /// <summary>
        /// Provides access to the underlying input action "EXPLORATION/EscapeMenu".
        /// </summary>
        public InputAction @EscapeMenu => m_Wrapper.m_EXPLORATION_EscapeMenu;
        /// <summary>
        /// Provides access to the underlying input action "EXPLORATION/CancelCharacterSelection".
        /// </summary>
    ...
    // BLOCK_BREAK
    private readonly InputActionMap m_BLOCK_BREAK;
    private List<IBLOCK_BREAKActions> m_BLOCK_BREAKActionsCallbackInterfaces = new List<IBLOCK_BREAKActions>();
    private readonly InputAction m_BLOCK_BREAK_Select;
    private readonly InputAction m_BLOCK_BREAK_Cancel;
    private readonly InputAction m_BLOCK_BREAK_Navigate;
    private readonly InputAction m_BLOCK_BREAK_CombatDetails;
    private readonly InputAction m_BLOCK_BREAK_RightClick;
    /// <summary>
    /// Provides access to input actions defined in input action map "BLOCK_BREAK".
    /// </summary>
    public struct BLOCK_BREAKActions
    {
        private @GameControls m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public BLOCK_BREAKActions(@GameControls wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "BLOCK_BREAK/Select".
        /// </summary>
        public InputAction @Select => m_Wrapper.m_BLOCK_BREAK_Select;
        /// <summary>
        /// Provides access to the underlying input action "BLOCK_BREAK/Cancel".
        /// </summary>
        public InputAction @Cancel => m_Wrapper.m_BLOCK_BREAK_Cancel;
        /// <summary>
        /// Provides access to the underlying input action "BLOCK_BREAK/Navigate".
        /// </summary>
        public InputAction @Navigate => m_Wrapper.m_BLOCK_BREAK_Navigate;
        /// <summary>
        /// Provides access to the underlying input action "BLOCK_BREAK/CombatDetails".
        /// </summary>
        public InputAction @CombatDetails => m_Wrapper.m_BLOCK_BREAK_CombatDetails;
        /// <summary>
        /// Provides access to the underlying input action "BLOCK_BREAK/RightClick".
        /// </summary>
        public InputAction @RightClick => m_Wrapper.m_BLOCK_BREAK_RightClick;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_BLOCK_BREAK; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="BLOCK_BREAKActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(BLOCK_BREAKActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="BLOCK_BREAKActions" />
        public void AddCallbacks(IBLOCK_BREAKActions instance)
        {
            if (instance == null || m_Wrapper.m_BLOCK_BREAKActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_BLOCK_BREAKActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="BLOCK_BREAKActions" />
        private void UnregisterCallbacks(IBLOCK_BREAKActions instance)
        {
            @Select.started -= instance.OnSelect;
            @Select.performed -= instance.OnSelect;
            @Select.canceled -= instance.OnSelect;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="BLOCK_BREAKActions.UnregisterCallbacks(IBLOCK_BREAKActions)" />.
        /// </summary>
        /// <seealso cref="BLOCK_BREAKActions.UnregisterCallbacks(IBLOCK_BREAKActions)" />
        public void RemoveCallbacks(IBLOCK_BREAKActions instance)
        {
            if (m_Wrapper.m_BLOCK_BREAKActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="BLOCK_BREAKActions.AddCallbacks(IBLOCK_BREAKActions)" />
        /// <seealso cref="BLOCK_BREAKActions.RemoveCallbacks(IBLOCK_BREAKActions)" />
        /// <seealso cref="BLOCK_BREAKActions.UnregisterCallbacks(IBLOCK_BREAKActions)" />
        public void SetCallbacks(IBLOCK_BREAKActions instance)
        {
            foreach (var item in m_Wrapper.m_BLOCK_BREAKActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_BLOCK_BREAKActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="BLOCK_BREAKActions" /> instance referencing this action map.
    /// </summary>
    public BLOCK_BREAKActions @BLOCK_BREAK => new BLOCK_BREAKActions(this);
    ...
    public interface IEXPLORATIONActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "ExplorationMenu" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        ...
        /// <summary>
        /// Method invoked when associated input action "CancelCharacterSelection" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "BLOCK_BREAK" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="BLOCK_BREAKActions.AddCallbacks(IBLOCK_BREAKActions)" />
    /// <seealso cref="BLOCK_BREAKActions.RemoveCallbacks(IBLOCK_BREAKActions)" />
    public interface IBLOCK_BREAKActions
    {
        /// <summary>
        ...
        /// <summary>
        /// Method invoked when associated input action "CombatDetails" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
